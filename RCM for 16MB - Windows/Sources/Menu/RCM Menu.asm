...
Start:
	...
	ld	hl,09000h
	ld	e,1
	call	WRSLT					; Select the segment 1 on the page 8000h-9FFFh
...
NoScreen1:
	if	Offset!=0				; Sets up the offset segment
	ld	a,(RamBottom+14)
	ld	e,a
	ld	a,(RomSlot)
	ld	hl,OffsetReg
...
ExeByJump:
	...
	push	de
	pop	ix
	jp	(ix)					; Execute the selected Rom with INIT address between 4000h and 7FFFh
